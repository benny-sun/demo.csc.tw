(function () {
    var t, e, n, r, s, o, i, u, a, c, l, p, h, f, g, d, m, y, v, w, b, k, S, q, L, x, P, T, R, j, E, O, M, A, N, _, F,
        C, U, W, X, D, H, I, z, G, B, J, K, Q = [].slice, V = {}.hasOwnProperty, Y = function (t, e) {
            function n() {
                this.constructor = t
            }
    ...
    for (b = {
        ...
        return t.prototype.on = function (t, e, n, r) {
            ...
            if (n = arguments[0], t = 2 <= arguments.length ? Q.call(arguments, 1) : [], null != (i = this.bindings) ? i[n] : void 0) {
                for (s = 0, a = []; s < this.bindings[n].length;)u = this.bindings[n][s], r = u.handler, e = u.ctx, o = u.once, r.apply(null != e ? e : this, t), a.push(o ? this.bindings[n].splice(s, 1) : s++);
                return a
            }
        }, t
    ...
    a = function (t) {
        ...
        return t.prototype.getElement = function () {
            var t;
            if (null == this.el) {
                if (t = document.querySelector(j.target), !t)throw new a;
            ...
            for (t = this.getElement(), r = "translate3d(" + (0 | this.progress) + "%, 0, 0)", i = ["webkitTransform", "msTransform", "transform"], s = 0, o = i.length; o > s; s++)e = i[s], t.children[0].style[e] = r;
        ...
        var e, n, r, s;
        for (s = j.ajax.ignoreURLs, n = 0, r = s.length; r > n; n++)if (e = s[n], "string" == typeof e) {
        ...
        return o = e.type, s = e.request, i = e.url, N(i) ? void 0 : c.running || j.restartOnRequestAfter === !1 && "force" !== _(o) ? void 0 : (r = arguments, n = j.restartOnRequestAfter || 0, "boolean" == typeof n && (n = 0), setTimeout(function () {
            ...
            if (e = "socket" === o ? s.readyState < 2 : 0 < (u = s.readyState) && 4 > u) {
                for (c.restart(), a = c.sources, l = [], n = 0, i = a.length; i > n; n++) {
                    if (F = a[n], F instanceof t) {
                        F.watch.apply(F, r);
                        break
                    }
                    l.push(void 0)
        ...
        return t.prototype.watch = function (t) {
            var e, n, r, s;
            return r = t.type, e = t.request, s = t.url, N(s) ? void 0 : (n = "socket" === r ? new f(e) : new g(e), this.elements.push(n))
        }, t
    }(), g = function () {
        function t(t) {
            ...
            if (this.progress = 0, null != window.ProgressEvent)for (n = null, t.addEventListener("progress", function (t) {
                ...
                var e;
                return 0 === (e = t.readyState) || 4 === e ? u.progress = 100 : 3 === t.readyState && (u.progress = 50), "function" == typeof o ? o.apply(null, arguments) : void 0
            }
        }
    ...
    }(), C = null, A = null, y = null, U = null, d = null, v = null, c.running = !1, x = function () {
    ...
    }), p = {ajax: t, elements: r, document: n, eventLag: o}, (T = function () {
        var t, n, r, s, o, i, u, a;
        ...
        return c.trigger("stop"), c.running = !1, y.destroy(), v = !0, null != d && ("function" == typeof w && w(d), d = null), T()
    }, c.restart = function () {
        return c.trigger("restart"), c.stop(), c.start()
    }, c.go = function () {
        var t;
        return c.running = !0, y.render(), t = R(), v = !1, d = M(function (e, n) {
            var r, s, o, i, u, a, l, p, f, g, d, m, w, b, k, S;
            for (p = 100 - y.progress, s = d = 0, o = !0, a = m = 0, b = C.length; b > m; a = ++m)for (F = C[a], g = null != A[a] ? A[a] : A[a] = [], u = null != (S = F.elements) ? S : [F], l = w = 0, k = u.length; k > w; l = ++w)i = u[l], f = null != g[l] ? g[l] : g[l] = new h(i), o &= f.done, f.done || (s++, d += f.tick(e));
            return r = d / s, y.update(U.tick(e, r)), y.done() || o || v ? (y.update(100), c.trigger("done"), setTimeout(function () {
