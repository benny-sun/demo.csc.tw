        ...
        socialShare: function(options) {
            ...
            function createContainer(){
                var siteSettings = {
                    ...
                    'facebook': { text: 'Facebook', className: 'aFacebook', url: 'https://www.facebook.com/sharer/sharer.php?u={u}' },
                    ...
                    'qq': { text: 'QQ', className: 'aQQ', url: 'http://connect.qq.com/widget/shareqq/index.php?url={u}&title={t}&source=&desc={d}&pics={p}'},
